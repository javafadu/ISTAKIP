...
$mail->SetFrom("info@aswagroup.com", "ASWA Group"); // Mail atıldığında gorulecek isim ve email (genelde yukarıdaki username kullanılır)
$mail->AddAddress("feridunozcelik@gmail.com"); // Mailin gönderileceği alıcı adres
$mail->Subject = "Türkçe Ağıltı"; // Email konu başlığı
$mail->Body = "Türkçe mail gönderilecek bakalım gidecek mi"; // Mailin içeriği
if(!$mail->Send()){
